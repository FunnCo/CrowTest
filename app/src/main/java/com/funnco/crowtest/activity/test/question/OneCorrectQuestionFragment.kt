 ...
 * Use the [OneCorrectQuestionFragment.newInstance] factory method to
...
class OneCorrectQuestionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OneCorrectQuestionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OneCorrectQuestionFragment().apply {
